...
/**
 * from column d of C (of size NxnD), Fill first lines of U  with 1 in first line and
 * the column d of C in second line
 *
 * @param U	the output parameter (of size KpxN)
