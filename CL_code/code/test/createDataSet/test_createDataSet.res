...
[1;36m # Tests [0;39m
[1;32m [OK] [0;39m ok_log() ./test_register_cds -x input_file.txt
[1;32m [OK] [0;39m ok_log() ./test_register_cds -h
[1;32m [OK] [0;39m ok_log() ./test_register_cds -x input_file.txt -m 1 -s 10 -r 0.05
[1;32m [OK] [0;39m ok_log() ./test_register_cds -x input_file.txt -m 2 -s 10 -r 0.05
[1;32m [OK] [0;39m ok_log() ./test_register_cds -x input_file.txt -m 3 -s 10 -r 0.05
[1;32m [OK] [0;39m ok_log() ./test_register_cds -x input_file.txt -o output.txt
[1;32m [OK] [0;39m ok_log() ./test_register_cds 
[1;32m [OK] [0;39m ok_log() ./test_register_cds -x 
[1;32m [OK] [0;39m ok_log() ./test_register_cds -x input_file.txt -m 0 
[1;32m [OK] [0;39m ok_log() ./test_register_cds -x input_file.txt -m -1
[1;32m [OK] [0;39m ok_log() ./test_register_cds -x input_file.txt -m a
[1;32m [OK] [0;39m ok_log() ./test_register_cds -x input_file.txt -m
[1;32m [OK] [0;39m ok_log() ./test_register_cds -x input_file.txt -s -1
[1;32m [OK] [0;39m ok_log() ./test_register_cds -x input_file.txt -s
[1;32m [OK] [0;39m ok_log() ./test_register_cds -x input_file.txt -r 0 
[1;32m [OK] [0;39m ok_log() ./test_register_cds -x input_file.txt -r 1 
[1;32m [OK] [0;39m ok_log() ./test_register_cds -x input_file.txt -r -1
[1;32m [OK] [0;39m ok_log() ./test_register_cds -x input_file.txt -r a
[1;32m [OK] [0;39m ok_log() ./test_register_cds -x input_file.txt -r
