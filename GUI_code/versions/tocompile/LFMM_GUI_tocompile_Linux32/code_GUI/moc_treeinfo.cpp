...
**
** Created: Fri May 24 13:23:10 2013
...
void TreeInfo::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    Q_UNUSED(_o);
    Q_UNUSED(_id);
    Q_UNUSED(_c);
...
const QMetaObjectExtraData TreeInfo::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject TreeInfo::staticMetaObject = {
    { &TreeWidget::staticMetaObject, qt_meta_stringdata_TreeInfo,
      qt_meta_data_TreeInfo, &staticMetaObjectExtraData }
};
