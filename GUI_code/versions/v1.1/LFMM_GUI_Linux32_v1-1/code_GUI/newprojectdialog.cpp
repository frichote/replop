    ...
    : QDialog(parent)
{
	...
	nameHelp->setIcon(QIcon(tr("images/help.png")));
	...
	pathHelp->setIcon(QIcon(tr("images/help.png")));
	...
	geoDataHelp->setIcon(QIcon(tr("images/help.png")));
	...
	nameDataHelp->setIcon(QIcon(tr("images/help.png")));
	...
	nLabelHelp->setIcon(QIcon(tr("images/help.png")));
	...
	lLabelHelp->setIcon(QIcon(tr("images/help.png")));
	...
	connect(lLabelHelp, SIGNAL(clicked()), this, SLOT(help()));
        ...
        dLabelHelp->setIcon(QIcon(tr("images/help.png")));
	...
	mLabelHelp->setIcon(QIcon(tr("images/help.png")));
...
void NewProjectDialog::changeProjectDataFormat() {
        ...
        if (dataLineEdit->text().endsWith(tr(".ped")))
        {
           ...
           .arg(lLineEdit->text())
           .arg(nLineEdit->text());
        } else if (dataLineEdit->text().endsWith(tr(".ancestrymapgen")))
        {
                cmdLine =
           tr("perl ./scripts/ancestrymapgen2lfmm.pl %1 %2 %3 %4")
           .arg(dataLineEdit->text())
           .arg(newData)
           .arg(lLineEdit->text())
           .arg(nLineEdit->text());
        } else if (dataLineEdit->text().endsWith(tr(".eigenstrat")))
        {
                cmdLine =
...
void NewProjectDialog::viewData()
{
	...
	{
		QMessageBox::warning(this, GUI_TITLE, 
			tr("The specified genotypic data file does not exist."));
		return;
	}
