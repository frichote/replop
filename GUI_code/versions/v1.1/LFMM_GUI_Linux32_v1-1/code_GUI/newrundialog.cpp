...
: QDialog(parent)
{
	...
	//VBRadioButton->setEnabled(false);
        ...
        methodHelp->setIcon(QIcon(tr("images/help.png")));
	...
	connect(scriptCheckBox, SIGNAL(stateChanged(int)), this, SLOT(scriptStateChanged(int)));
        ...
        scriptHelp->setIcon(QIcon(tr("images/help.png")));
	...
	rLineEdit->setValidator(rV);
        ...
        rHelp->setIcon(QIcon(tr("images/help.png")));
        rHelp->setText(tr("r"));
	...
	connect(advanced, SIGNAL(clicked()), this, SLOT(advOpt()));
        ...
        kHelp->setIcon(QIcon(tr("images/help.png")));
        kHelp->setText(tr("k"));
        ...
        dHelp->setIcon(QIcon(tr("images/help.png")));
        dHelp->setText(tr("d"));
	...
	sLineEdit->setValidator(sV);
        ...
        sHelp->setIcon(QIcon(tr("images/help.png")));
        sHelp->setText(tr("s"));
	...
	bLineEdit->setValidator(bV);
        ...
        bHelp->setIcon(QIcon(tr("images/help.png")));
        bHelp->setText(tr("b"));
