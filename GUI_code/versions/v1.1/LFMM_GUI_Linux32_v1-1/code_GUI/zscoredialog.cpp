...
: QDialog(parent)
{
	...
	runComboBox = new QComboBox;
        ...
        runHelp->setIcon(QIcon(tr("images/help.png")));
	...
	numberLabel = new QLabel(tr("The current number of snps displayed is 0."));
        ...
        numberHelp->setIcon(QIcon(tr("images/help.png")));
	...
	chrComboBox = new QComboBox;
        ...
        chrHelp->setIcon(QIcon(tr("images/help.png")));
	...
	nameSearchLineEdit = new QLineEdit;
        ...
        nameSearchHelp->setIcon(QIcon(tr("images/help.png")));
	...
	maxPositionLineEdit->setValidator(kV);
        ...
        positionHelp->setIcon(QIcon(tr("images/help.png")));
	...
	maxZscoreLineEdit->setValidator(kV);
        ...
        zscoreHelp->setIcon(QIcon(tr("images/help.png")));
	...
	maxPvalueLineEdit->setValidator(kV);
        ...
        pvalueHelp->setIcon(QIcon(tr("images/help.png")));
	...
	maxlPvalueLineEdit->setValidator(kV);
        ...
        lpvalueHelp->setIcon(QIcon(tr("images/help.png")));
	...
	toTextPushButton = new QPushButton(tr("Export Displayed Table to Text File"));
        ...
        toTextHelp->setIcon(QIcon(tr("images/help.png")));
	...
	toPlotPushButton = new QPushButton(tr("Create Manhattan Plot assciated with current Table"));
        ...
        toPlotHelp->setIcon(QIcon(tr("images/help.png")));
	...
	toGreenPlotPushButton = new QPushButton(tr("Create Manhattan Plot with all snps and in green snps in the table"));
        ...
        toGreenPlotHelp->setIcon(QIcon(tr("images/help.png")));
...
void ZscoreDialog::updateZscoreTable()
{
	...
	for (int j = 0; j < nbSnp; j++)
	{
		if (snps[j].OK) {
			...
			//run names
			QTableWidgetItem *name = new QTableWidgetItem(tr("%1").arg(snps[j].name));
			name->setFlags(Qt::ItemIsEnabled);
			zscoreTable->setItem(i,0,name);

			QTableWidgetItem *chr = new QTableWidgetItem(tr("%1").arg(snps[j].chromosome));
			...
			QTableWidgetItem *pos = new QTableWidgetItem(tr("%1").arg(snps[j].position));
			pos->setFlags(Qt::ItemIsEnabled);
			zscoreTable->setItem(i,2,pos);

			QTableWidgetItem *z = new QTableWidgetItem(tr("%1").arg(snps[j].zscore));
			z->setFlags(Qt::ItemIsEnabled);
			zscoreTable->setItem(i,3,z);

			QTableWidgetItem *lp = new QTableWidgetItem(tr("%1").arg(snps[j].lpvalue));
			lp->setFlags(Qt::ItemIsEnabled);
			zscoreTable->setItem(i,4,lp);

			QTableWidgetItem *p = new QTableWidgetItem(tr("%1").arg(snps[j].pvalue));
